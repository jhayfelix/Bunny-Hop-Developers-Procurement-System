...
public class CheckOrderDetailsController extends Controller {
	...
	@FXML private TableColumn<Payment, LocalDateTime> paymentDateTimeColumn;
	@FXML private TableColumn<Payment, Double> amountPaidColumn;
	...
	public void initialize(Order order) {
		...
		unpaidCostText.setText(order.getUnpaidAmount() + " out of " + order.getTotalAmount());
		...
		// table of payments
		paymentDateTimeColumn.setCellValueFactory(new PropertyValueFactory<Payment, LocalDateTime>("paidDateTime"));
		amountPaidColumn.setCellValueFactory(new PropertyValueFactory<Payment, Double>("paidAmount"));	
		paymentsTableView.getItems().addAll(order.getPayments());
	}
